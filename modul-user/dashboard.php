            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalRegister"><i class="fa-solid fa-plus"></i> Tambah Data</button>
                        ...
                        <table class="table table-responsive">
                            ...
                            <button class="btn btn-warning mb-2"><a href="print.php" style="color: #fff;">Print</a></button>
                            <tbody>
                                <?php
                                while ($r = mysqli_fetch_object($d)) {
                                    ...
                                    echo '<td><a href="#" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal' . $r->id_user . '"><i class="fa-regular fa-pen-to-square"></i></a></td>';
                                    echo '<td><form action="" method="post"><input name="id_user" type="hidden" value=' . $r->id_user . '><button type="submit" class="btn btn-danger"><i class="fa-solid fa-trash"></i></form></td>';
                                    echo '<td></td></tr>';
