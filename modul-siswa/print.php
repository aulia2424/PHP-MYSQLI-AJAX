            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <button class="btn btn-success" data-toggle="modal" data-target="#modalAdd"><i class="fa-solid fa-plus"></i> Tambah Data</button>
                        ...
                        <table class="table table-responsive">
                            <thead>
                                ...
                                <button class="btn btn-primary mb-2"><a href="dashboard.php" style="color: #fff;">back to dashboard</a></button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="" method="post">
                                                ...
                                                <button name="hapusSiswa" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button>
                                                
                                            </form>
                                        </td>

                                        <td><button class="btn btn-primary" data-toggle="modal" data-target="#modalUpdate<?= $d->id_siswa ?>"><i class="fa-regular fa-pen-to-square"></i></button>
